...
function ciclistaRosa(){
        jogador1 =createSprite(camera.x,Math.round(random(50, 750)));
        jogador1.scale =0.06;
...
function ciclistaAmarelo(){
        jogador2 =createSprite(1100,Math.round(random(50, 750)));
        jogador2.scale =0.06;
...
function ciclistaVermelho(){
        jogador3 =createSprite(1100,Math.round(random(50, 750)));
        jogador3.scale =0.06;
